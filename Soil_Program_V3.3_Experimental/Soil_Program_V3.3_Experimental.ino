...
//###For some reason arduino will not let me set up function below setup and loop?###
void extractGas(int active_solpin, int pumpPin, bool activate = true, int pumpLength = 5000) {
...
void loop() {
  ...
  for (int i = 0; i < 4; i++) {
    ...
    extractGas(active_solpin, pumpPin, true, 5000);
    //Debug Line
    Serial.println("End of pumping");
    ...
    //Debug Line
    Serial.println("End of ADC recording");
    ...
    //Debug Line
    Serial.println("End of BME 1 and 2 recording");
    ...
    //Debug Line
    Serial.println("end of voltage values");
    ...
    //Totally made up algorithm
    Battery_Lvl = ((Battery_Lvl * (80600 + 266066.67)) / 80600);
    Serial.println(Battery_Lvl);

    Serial.println("End of Battery Readout from ads2");
    //Let gas settle. Run measurements
    delay(3000);
